...
export default function AIChatWidget() {
  ...
  const [messages, setMessages] = useState([
    {
      role: "model",
      content: "আসসালামু আলাইকুম! আমি PetZone AI অ্যাসিস্ট্যান্ট। আপনার পোষা প্রাণীর যত্ন, রোগবালাই, আদর্শ খাবার অথবা আমাদের সাইট নেভিগেশনের যেকোনো বিষয় নিয়ে আমি আপনাকে সাহায্য করতে পারি। আজ আপনাকে কীভাবে সাহায্য করতে পারি?"
    }
  ]);
